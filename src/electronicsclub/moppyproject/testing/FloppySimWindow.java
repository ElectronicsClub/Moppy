...
public class FloppySimWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comComboBox.setModel(new DefaultComboBoxModel(MoppyFloppySim
        ...
        drivesPanel.setBorder(javax.swing.BorderFactory
    ...
    private void comComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_comComboBoxActionPerformed
        String comPort = (String) ((JComboBox) evt.getSource())
                .getSelectedItem();
        try {
            app.mCom.openPort(comPort);
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(rootPane, ex);
            Logger.getLogger(FloppySimWindow.class.getName()).log(Level.SEVERE,
                    null, ex);
        }
