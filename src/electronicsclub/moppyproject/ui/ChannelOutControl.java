...
import electronicsclub.moppyproject.OutputSetting.OutputType;
...
public class ChannelOutControl extends javax.swing.JPanel {
    ...
    private void enableControls() {
        ...
        if (moppyTypeRB.isSelected())
            outputTypeChanged(new ActionEvent(moppyTypeRB,
                    ActionEvent.ACTION_PERFORMED,
                    moppyTypeRB.getActionCommand()));
        else if (MIDITypeRB.isSelected())
            outputTypeChanged(new ActionEvent(MIDITypeRB,
                    ActionEvent.ACTION_PERFORMED, MIDITypeRB.getActionCommand()));
    ...
    private void initComponents() {
        ...
        moppyTypeRB
                .setToolTipText("Sends Moppy-protocol serial data to selected COM port");
        ...
        MIDITypeRB
                .setToolTipText("Sends MIDI messages through to selected MIDI port");
        ...
        comComboBox.setModel(new DefaultComboBoxModel(
                electronicsclub.moppyproject.outputs.MoppyCOMBridge
        ...
        midiOutComboBox
                .setModel(new DefaultComboBoxModel(
                        controlWindow.availableMIDIOuts.keySet().toArray(
                                new String[0])));
        midiOutComboBox.setEnabled(false);
    ...
    private void comComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_comComboBoxActionPerformed
        settings.comPort = (String) ((JComboBox) evt.getSource())
                .getSelectedItem();
    ...
    private void midiOutComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_midiOutComboBoxActionPerformed
        settings.midiDeviceName = (String) ((JComboBox) evt.getSource())
                .getSelectedItem();
