...
public class MIDIInControls extends InputPanel {
    ...
    private void initComponents() {
        ...
        midiInComboBox.setModel(new DefaultComboBoxModel(availableMIDIIns
    ...
    private void midiInComboBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_midiInComboBoxActionPerformed
        try {
            midiInput.setDevice(availableMIDIIns.get(((JComboBox) evt
                    .getSource()).getSelectedItem()));
        } catch (MidiUnavailableException ex) {
            Logger.getLogger(MIDIInControls.class.getName()).log(Level.SEVERE,
                    null, ex);
        }
    ...
    public void disconnected() {
        midiInput.setReceiver(null); // Clear out receiver so that MIDI messages
