 ...
 * 
 */
public class SequencerControls extends InputPanel implements
        MoppyStatusConsumer {
     ...
     */
    public SequencerControls(MoppyUI app, MoppyControlWindow mcw,
            MoppySequencer newSequencer) {
        seq = newSequencer;
        this.app = app;
        controlWindow = mcw;
    ...
    private void updateProgressDisplay() {
        ...
        String currentPosition = String
                .format("%d:%02d", TimeUnit.SECONDS.toMinutes(currentSeconds),
                        currentSeconds % 60);
    ...
    private void loadButtonloadSequence(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loadButtonloadSequence
        String previouslyLoaded = app.prefs
                .get(Constants.PREF_LOADED_SEQ, null);
